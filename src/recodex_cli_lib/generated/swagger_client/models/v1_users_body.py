...
class V1UsersBody(object):
    ...
    def __init__(self, email=None, first_name=None, last_name=None, password=None, password_confirm=None, instance_id=None, titles_before_name=None, titles_after_name=None):  # noqa: E501
