...
class IdSettingsBody(object):
    ...
    def assignment_submit_after_accepted_emails(self):
        ...
        Flag if email should be sent to group supervisor if a student submits new solution for already accepted assignment  # noqa: E501
    ...
    def solution_review_requested_emails(self):
        ...
        Flag if notification should be send to a teacher when a solution reviewRequested flag is chagned in a supervised/admined group.  # noqa: E501
